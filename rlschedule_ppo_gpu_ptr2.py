# python rlschedule_ppo.py --workload "./data/PIK-IPLEX-2009-1.swf" --exp_name pik1-ppo-t1024e100 --trajs 10 --seed 3 --epochs 100
...
class PPOBuffer:
    ...
    def sample(self):
        ...
        data.update(data_ori) # dictionary의 update 메서드
